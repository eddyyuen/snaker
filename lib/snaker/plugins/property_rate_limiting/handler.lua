...
local counter = require("snaker.plugins.property_rate_limiting.counter")
...
function PropertyRateLimitingHandler:access(conf)
    ...
    local enable = snaker_db.get(plugin_config.table_name..".enable")
    local meta = snaker_db.get(plugin_config.table_name..".meta")
    local selectors = snaker_db.get(plugin_config.table_name..".selectors")
