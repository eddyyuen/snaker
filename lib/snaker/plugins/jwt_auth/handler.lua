...
function JwtAuthHandler:access(conf)
    ...
    local enable = snaker_db.get("jwt_auth.enable")
    local meta = snaker_db.get("jwt_auth.meta")
    local selectors = snaker_db.get("jwt_auth.selectors")
    local ordered_selectors = meta and meta.selectors
    
    -- ngx.log(ngx.INFO, "==[JwtAuth][PASS THROUGH SELECTOR:",enable,#meta,#selectors,#ordered_selectors, "]")
