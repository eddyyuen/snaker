...
local snaker_db = require("snaker.store.snaker_db")
...
function RewriteHandler:rewrite(conf)
    ...
    local enable = snaker_db.get("rewrite.enable")
    local meta = snaker_db.get_json("rewrite.meta")
    local selectors = snaker_db.get_json("rewrite.selectors")
